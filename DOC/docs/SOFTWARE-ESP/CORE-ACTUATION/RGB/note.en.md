...
!!! note
    In this section, we explain the driving and control of the onboard RGBLED on the development board. By modifying the GPIO pin, the code can also be used for other development boards.
