...
```txt
- DNESP32S3M-XXX/
             - .vscode/ (vscode setup files, can be ignored)
             ...
             - dependencies.lock (dependency library version lock file, automatically generated, please remove it before the first build)
             - application/         - component1/ - CMakeLists.txt
                                                  - Kconfig
                                                  - src1.c
                                    - component2/ - CMakeLists.txt
