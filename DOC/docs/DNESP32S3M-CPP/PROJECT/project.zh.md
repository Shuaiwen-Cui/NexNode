...
!!! danger
    必须注意 `set(EXTRA_COMPONENT_DIRS "./driver" "./middleware" "./application")` 必须放在 `project(DNESP32S3M)` 之前。否则，项目将无法在这些目录中找到组件。参考 [LINK](https://blog.51cto.com/u_16099361/12129084)。
