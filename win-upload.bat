...
@REM git push -f https://github.com/Shuaiwen-Cui/NexNode.git main
git push -f https://github.com/Shuaiwen-Cui/NexNode.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/NexNode.git
